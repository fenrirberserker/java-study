...
- [💻 Programming Languages](#-programming-languages)
  - [☕ Java](#-java)
    ...
    - [🧵 Concurrency and Parallelism](#-concurrency-and-parallelism)
      ...
      - [3. Lambdas as Thread Tasks (Java 8)](#3-lambdas-as-thread-tasks-java-8)
      ...
      - [8. Explicit Locks (`ReentrantLock`, `ReadWriteLock`) (Java 5; `StampedLock` Java 8)](#8-explicit-locks-reentrantlock-readwritelock-java-5-stampedlock-java-8)
      - [9. Atomic Variables (Java 5)](#9-atomic-variables-java-5)
      - [10. Concurrent Collections (Java 5)](#10-concurrent-collections-java-5)
      - [11. The Concurrent Application Programming Interface — `ExecutorService`, `Callable`, `Future` (Java 5)](#11-the-concurrent-application-programming-interface--executorservice-callable-future-java-5)
      - [12. Thread Communication — `wait` / `notify`, Producer-Consumer](#12-thread-communication--wait--notify-producer-consumer)
      - [13. `CompletableFuture` (Java 8)](#13-completablefuture-java-8)
      - [14. Coordination Primitives — `CountDownLatch`, `CyclicBarrier`, `Semaphore`, `Phaser`, `Exchanger` (Java 5; `Phaser` Java 7)](#14-coordination-primitives--countdownlatch-cyclicbarrier-semaphore-phaser-exchanger-java-5-phaser-java-7)
      - [15. Deadlock, Livelock, Starvation](#15-deadlock-livelock-starvation)
      - [16. Code Challenges](#16-code-challenges)
      - [🧠 Concurrency Cheat Sheet](#-concurrency-cheat-sheet)
    - [⚠️ Exceptions](#-exceptions)
      - [1. Concepts & Vocabulary (Exceptions)](#1-concepts--vocabulary-exceptions)
      ...
      - [🧠 Exceptions Cheat Sheet](#-exceptions-cheat-sheet)
  - [🟪 Kotlin](#-kotlin)
...
- [🏢 System Design](#-system-design)
  ...
  - [🌐 Distributed Design Patterns](#-distributed-design-patterns)
    ...
    - [📨 Messaging](#-messaging)
      ...
      - [Why messaging belongs to distributed design patterns](#why-messaging-belongs-to-distributed-design-patterns)
...
> 💻 Code: [LinkedListExample](../src/concepts/collections/Lists/LinkedListExample.java) · [SetExample](../src/concepts/collections/Sets/SetExample.java) · [MapExample](../src/concepts/collections/Maps/MapExample.java) · [Binary Search Tree](../src/concepts/search/trees/BST.java) · [Trie](../src/algorithms/search/trie/Trie.java) · [Least Recently Used cache](../src/algorithms/search/lru/demo1/LRUCache.java)
...
#### Big O Notation
Notation to measure algorithms efficiency in terms of time and space complexity
...
> 💻 Code: [BubbleSort](../src/algorithms/sorting/BubbleSort.java) · [MergeSort](../src/algorithms/sorting/MergeSort.java) · [QuickSort](../src/algorithms/sorting/QuickSort.java) · [Arrays.sort & comparators](../src/algorithms/sorting/ArraysSort.java)
...
> 💻 Code: [BinarySearch](../src/algorithms/search/BinarySearch.java) · [BreadthFirstSearch](../src/algorithms/search/bfs/BreadthFirstSearch.java) · [DepthFirstSearch](../src/algorithms/search/dfs/DepthFirstSearch.java) · [Tree traversals](../src/algorithms/trees/BreadthFirstSearch.java)
- **Binary search**
...
> 💻 Code: [StringPools](../src/algorithms/strings/StringPools.java) · [ImmutableTest](../src/concepts/Immutability/ImmutableTest.java)
...
> 💻 Code: [Polymorphism](../src/concepts/oop/Polymorphism.java) · [PlayWithAnimal](../src/concepts/oop/polimorfism/PlayWithAnimal.java) · [AbstractClassTest](../src/concepts/abstractclasses/AbstractClassTest.java) · [Interfaces](../src/concepts/interfaces/MyImpl.java) · [Default methods](../src/concepts/defaults/DefaultImpl.java)
...
- **Abstraction**: Expose *what* a type does (interface, abstract class), hide *how* it does it — callers program against the contract, not the algorithms
...
> 💻 Code: [HashTest](../src/concepts/hashcode/HashTest.java)
...
> 💻 Code: [OrderList](../src/concepts/collections/Lists/OrderList.java) · [SetExample](../src/concepts/collections/Sets/SetExample.java) · [MapExample](../src/concepts/collections/Maps/MapExample.java) · [Conversions](../src/concepts/convert/ArraysAndLists.java) · [Comparators](../src/algorithms/sorting/SortPlayersByScoreDecreasing.java)
...
> 💻 Code: [FunctionAndBiFunction](../src/concepts/functionalinterfaces/FunctionAndBiFunction.java) · [PredicateAndBiPredicate](../src/concepts/functionalinterfaces/PredicateAndBiPredicate.java) · [ConsumerAndBiConsumer](../src/concepts/functionalinterfaces/ConsumerAndBiConsumer.java) · [SupplierExample](../src/concepts/functionalinterfaces/SupplierExample.java) · [UnaryAndBinaryOperator](../src/concepts/functionalinterfaces/UnaryOperatorAndBinaryOperator.java) · [Lambdas](../src/concepts/lambda/FindMatchingAnimals.java)
...
> 💻 Code: [MapAndFlatMap](../src/concepts/streams/MapAndFlatMap.java) · [Filter](../src/concepts/streams/Filter.java) · [Grouping](../src/concepts/streams/collect/Grouping.java) · [Partitioning](../src/concepts/streams/collect/Partitioning.java) · [Reductor](../src/concepts/streams/collect/Reductor.java) · [PrimitiveStreams](../src/concepts/streams/PrimitiveStreams.java) · [Short-circuit matches](../src/concepts/streams/AllMatchAnyMatchNoneMatch.java)
...
> 💻 Code: [OptionalExample](../src/concepts/optional/OptionalExample.java) · [OptionalNull](../src/concepts/optional/OptionalNull.java)
...
> 💻 Code: [VirtualThreadsExample](../src/concepts/threads/executors/VirtualThreadsExample.java)
...
> 💻 Code: [ThreadBasics](../src/concepts/threads/basics/ThreadBasics.java) · [ExecutorServiceExample](../src/concepts/threads/executors/ExecutorServiceExample.java) · [CompletableFutureExample](../src/concepts/threads/advanced/CompletableFutureExample.java) · [AtomicExample](../src/concepts/threads/atomic/AtomicExample.java) · [SynchronizedExample](../src/concepts/threads/synchronization/SynchronizedExample.java) · [ProducerConsumerExample](../src/concepts/threads/communication/ProducerConsumerExample.java)
...
| `ReentrantReadWriteLock` | The standard `ReadWriteLock` algorithms. Both views are reentrant; supports lock downgrading (write → read) but not upgrading. |
...
| Class | Use |
|---|---|
| `ThreadPoolExecutor` | The configurable thread-pool algorithms behind most `Executors` factories. Lets you set core/max pool sizes, keep-alive time, work queue, `ThreadFactory`, and rejection policy. |
| `ScheduledThreadPoolExecutor` | The configurable algorithms behind the scheduled factories. |
...
| `ExecutorCompletionService<V>` | The standard `CompletionService` algorithms, wrapping any `Executor`. |
...
| `UnsupportedOperationException` | `RuntimeException` | An interface method that is required to exist but is not supported by this algorithms (e.g. `List.of(...).add(x)`). |
...
*Annotations should be placed on the algorithms, not the interface maintain decoupling*
...
RouterFunctions<ServerResponse> myRoute =
    RouterFunctions.route(
        ...
        request->Response.ok().body(productFlux) // pass an algorithms of the handler function interface
    );
...
Every core concept above is implemented as a self-contained, executable class (each with a `main` and prints) under [src/concepts/spring/](../src/concepts/spring/), following the same style as the algorithms `*Basics.java` guides. Dependencies are declared in [build.gradle](../build.gradle) (`spring-context`, `aspectjweaver`, `jakarta.annotation-api`). Run any class directly from the IDE, or from the command line with the Gradle wrapper:
...
##### 1. Inversion of Control & the container — [IocContainerExample.java](../src/concepts/spring/ioc/IocContainerExample.java)
...
##### 2. The three injection types + disambiguation — [InjectionTypesExample.java](../src/concepts/spring/di/InjectionTypesExample.java)
```java
...
##### 3. Bean lifecycle & scopes — [BeanLifecycleAndScopesExample.java](../src/concepts/spring/lifecycle/BeanLifecycleAndScopesExample.java)
```java
@Component
...
##### 4. Proxies & the self-invocation gotcha — [AopProxyExample.java](../src/concepts/spring/aop/AopProxyExample.java)
...
##### 5. Application events (Observer pattern) — [ApplicationEventsExample.java](../src/concepts/spring/events/ApplicationEventsExample.java)
```java
...
##### 6. Strategy pattern via Map injection — [StrategyPatternExample.java](../src/concepts/spring/strategy/StrategyPatternExample.java)
The interview favorite — Spring injects every algorithms keyed by bean name, eliminating switch statements:
```java
...
##### 7. @Value & @Profile — [ValueAndProfilesExample.java](../src/concepts/spring/config/ValueAndProfilesExample.java)
```java
...
> 💻 Code: [FactoryTest](../src/concepts/designpatterns/creational/factory/FactoryTest.java) · [SingletonTest](../src/concepts/designpatterns/creational/singleton/SingletonTest.java) · [BuilderTest](../src/concepts/designpatterns/creational/builder/BuilderTest.java) · [AdapterTest](../src/concepts/designpatterns/structural/adapter/AdapterTest.java) · [Strategy via Spring](../src/concepts/spring/strategy/StrategyPatternExample.java) · [Observer via Spring events](../src/concepts/spring/events/ApplicationEventsExample.java) · [Proxy via Spring aspects](../src/concepts/spring/aop/AopProxyExample.java)
...
- **Template Method**: A base class fixes the skeleton of an algorithms, subclasses fill in the steps — `JdbcTemplate` and `RestTemplate` (the naming is literal)
...
> 💻 Code: [ExceptionTest (assertions & expected exceptions)](../src/concepts/exceptions/ExceptionTest.java)
...
> 💻 Code: [TestSerialization — Java binary serialization](../src/algorithms/files/TestSerialization.java)
